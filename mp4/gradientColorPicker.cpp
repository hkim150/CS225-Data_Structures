...
RGBAPixel gradientColorPicker::operator()(int x, int y)
{
    ...
    if(yOff < 0){yOff *= -1;}
    int off = xOff + yOff;
    if(off > radius){return fadeColor2;}
    color.red = fadeColor1.red - off*fadeColor1.red/radius + off*fadeColor2.red/radius;
    color.green = fadeColor1.green - off*fadeColor1.green/radius + off*fadeColor2.green/radius;
    color.blue = fadeColor1.blue - off*fadeColor1.blue/radius + off*fadeColor2.blue/radius;
    return color;
}
