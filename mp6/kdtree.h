...
class KDTree
{
  ...
  private:
     ...
     */
    void buildTree(int dim, int start, int end);
    int partition(int dim, int piv, int start, int end);
    void choose(int dim, int mean, int start, int end);
    void swap(int start, int end);
    Point<Dim> findNearestNeighbor(const Point<Dim>& query, const Point<Dim>& p, int dim, int start, int end) const;
};
